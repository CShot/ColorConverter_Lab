...
namespace Pankow_ColorConverter_Labs
{
    public partial class Form1 : Form
    {
        ...
        bool tmpStack = false;//индикатор нажатия на кнопки

        bool tmpUndo = false;//индикатор отмены
        ...
        private void открытьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                this.сохранитьToolStripMenuItem.Visible = true;
                this.фильтрыToolStripMenuItem.Visible = true;
        ...
        {
            //File.Open(@"StuctElem.txt", FileMode.Open);
            //FileInfo f = new FileInfo("StuctElem.txt");
           // StreamWriter w = f.CreateText();
            System.Diagnostics.Process.Start("StuctElem.txt");
        }
        ...
        private void отменаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tmpStack == true)//потому-что,из стека берется верхняя картинка
                {
